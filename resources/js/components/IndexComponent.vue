<template>
    <div class="flex flex-col min-h-screen">
            ...
            <div class="navMenu p-3 mt-1 flex flex-row justify-around" id="upperDiv">
                ...
                <div class="flex flex-col miniLinks">
                    ...
                    <div>
                        ...
                        <router-link :to="{name:'Main'}" class="h-[25px]">Acasă</router-link>
        ...
        <div class="theFooterMobile">
            <p class="text-white text-3xl p-6">
                Ministerul Finanțelor <br>Drepturi de autor © 2024. <br>Toate drepturile sunt rezervate.
            </p>
        </div>
    </div>
...
export default {
    name: "IndexComponent",
    components: {FooterComponent, SearchComponent, NavLinks},
